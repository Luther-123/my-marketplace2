        ...
        <div className="fixed inset-0 z-50 overflow-hidden font-sans">
            ...
            <div className="absolute inset-y-0 right-0 max-w-full flex pl-10">
                <div className="w-screen max-w-md shadow-2xl flex flex-col justify-between transition-colors duration-300 bg-white text-neutral-900 border-l border-neutral-200">
                    ...
                    <div className="p-6 border-t bg-neutral-50 border-neutral-100 space-y-3">
                        <div className="space-y-1 text-xs text-neutral-600">
                            <div className="flex justify-between">
                                <span>Subtotal</span>
                                <span className="font-bold text-neutral-950">Ksh {subtotal.toLocaleString()}</span>
                            </div>
                            <div className="flex justify-between">
                                <span>Shipping Flat Rate</span>
                                <span className="font-bold text-neutral-950">{cart.length > 0 ? `Ksh ${shipping.toLocaleString()}` : 'Ksh 0'}</span>
                            </div>
                            <div className="flex justify-between pt-2 border-t border-neutral-200 text-sm font-black text-neutral-950">
