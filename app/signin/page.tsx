        ...
        <div className="min-h-screen flex items-center justify-center p-6 font-sans bg-neutral-100 text-neutral-900 transition-colors duration-300">
            ...
            <div className="w-full max-w-md p-8 md:p-10 rounded-[2.5rem] border shadow-sm bg-white border-neutral-200 text-neutral-900">
                ...
                <div className="flex flex-col items-center text-center mb-6">
                    <div className="w-20 h-20 rounded-full bg-yellow-100 border border-yellow-200 flex items-center justify-center mb-3 text-neutral-950">
                        <User className="w-9 h-9" />
                    </div>
                    <h1 className="text-2xl font-black tracking-tight text-neutral-950">Welcome Back</h1>
                    <p className="text-xs text-neutral-500 mt-1">Sign in to your dashboard & continue.</p>
                </div>
                ...
                <div className="mt-6 text-center text-xs font-bold text-neutral-600">
                    ...
                    <Link href="/signup" className="underline hover:text-neutral-950 transition ml-1 font-black text-neutral-950">
                        Register
                    </Link>
                </div>
