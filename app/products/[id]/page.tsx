    ...
    return (
        <div className={`min-h-screen font-sans transition-colors duration-300 ${darkMode ? 'bg-neutral-950 text-white' : 'bg-neutral-100 text-neutral-900'}`}>
            ...
            <main className="max-w-7xl mx-auto px-6 py-12 space-y-16">
                    ...
                    <div className="lg:col-span-6 flex flex-col justify-between space-y-6">
                        <div className="space-y-4">
                            ...
                            <p className="text-xs md:text-sm text-neutral-400 leading-relaxed">
                                {product.description || 'Engineered with precision and premium craftsmanship. This item delivers exceptional quality, reliability, and modern minimalist design tailored for everyday performance.'}
                            </p>
                        </div>
                        ...
                        <div className="space-y-6 pt-6 border-t border-neutral-200 dark:border-neutral-800">
                            <div className="flex items-center gap-4">
                                ...
                                <div className={`flex items-center gap-3 rounded-2xl border px-3 py-2 ${darkMode ? 'border-neutral-800 bg-neutral-950' : 'border-neutral-200 bg-neutral-50'}`}>
                                    <button
                                        ...
                                        className="text-neutral-400 hover:text-neutral-950 dark:hover:text-white transition cursor-pointer"
                                    >
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button
                                    ...
                                    className="flex-1 py-4 bg-[#FACC15] text-neutral-950 font-black text-xs uppercase tracking-wider rounded-2xl hover:bg-yellow-400 transition shadow-md flex items-center justify-center gap-2 cursor-pointer"
                                >
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-4 font-black text-xs uppercase tracking-wider rounded-2xl border transition shadow-sm flex items-center justify-center gap-2 cursor-pointer ${darkMode ? 'border-neutral-700 hover:bg-neutral-800 text-white' : 'border-neutral-300 hover:bg-neutral-100 text-neutral-900'}`}
                                >
                                    Buy Now
                                </button>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 pt-4 text-xs text-neutral-400">
                                <div className="flex items-center gap-2">
                                    <Truck className="w-4 h-4 text-[#FACC15]" /> Express Delivery in Kenya
                                </div>
                                <div className="flex items-center gap-2">
                                    <ShieldCheck className="w-4 h-4 text-[#FACC15]" /> 1 Year Secure Warranty
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {/* Tabs Section: Product Details vs Customer Feedback */}
                <div className={`rounded-[2.5rem] border p-8 md:p-12 shadow-xl ${darkMode ? 'bg-neutral-900 border-neutral-800' : 'bg-white border-neutral-200'}`}>
                    <div className="flex items-center gap-8 border-b pb-4 border-neutral-200 dark:border-neutral-800 text-sm font-black">
                        <button
                            ...
                            className={`pb-2 border-b-2 transition cursor-pointer ${activeTab === 'details' ? 'border-[#FACC15] text-[#FACC15]' : 'border-transparent text-neutral-400 hover:text-neutral-950 dark:hover:text-white'}`}
                        >
                            Product Details & Specs
                        </button>
                        <button
                            onClick={() => setActiveTab('reviews')}
                            className={`pb-2 border-b-2 transition cursor-pointer ${activeTab === 'reviews' ? 'border-[#FACC15] text-[#FACC15]' : 'border-transparent text-neutral-400 hover:text-neutral-950 dark:hover:text-white'}`}
                        >
                    ...
                    <div className="py-6">
                        {activeTab === 'details' ? (
                            <div className="space-y-4 text-xs md:text-sm text-neutral-400 leading-relaxed">
                                ...
                                <p>Every unit goes through rigorous quality control inspections to ensure absolute durability, flawless finish, and maximum operational efficiency. Designed with high-grade components built to withstand everyday wear and tear.</p>
                                <ul className="list-disc pl-5 space-y-2 pt-2">
                                    <li>Premium minimalist architectural styling</li>
                                    <li>Tested for high-performance and longevity</li>
                                    <li>Eco-friendly packaging and responsible sourcing</li>
                                    <li>Backed by plugKe customer support in Nairobi</li>
                                </ul>
                            </div>
                        ) : (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {relatedProducts.map((item) => (
                                <div
                                    ...
                                    className={`group rounded-3xl border p-4 shadow-sm hover:shadow-md transition cursor-pointer flex flex-col justify-between ${darkMode ? 'bg-neutral-900 border-neutral-800 hover:border-neutral-700 text-white' : 'bg-white border-neutral-200 hover:border-neutral-300 text-neutral-900'}`}
                                >
                ...
                <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8 text-xs">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5 font-semibold">
                            <li><Link href="/" className="hover:text-neutral-950 dark:hover:text-white transition">Home Catalog</Link></li>
                            <li><Link href="/cart" className="hover:text-neutral-950 dark:hover:text-white transition">Shopping Cart</Link></li>
                            <li><Link href="/account" className="hover:text-neutral-950 dark:hover:text-white transition">Account Dashboard</Link></li>
                        </ul>
                    </div>
